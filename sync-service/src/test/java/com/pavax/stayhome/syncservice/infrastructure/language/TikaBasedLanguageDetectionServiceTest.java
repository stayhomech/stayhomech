...
class TikaBasedLanguageDetectionServiceTest {
	...
	void testDetectGerman() {
		// given
		final String text = "StayHome.ch ist eine Initative von privaten Personen, welche in Zeiten der Corona/Covid-19 Epidemie helfen möchten! Wir haben keinen kommerziellen Zweck.";

		// when
		final Optional<Language> language = languageDetectionService.detect(text);
	...
	void testDetectFrench() {
		// given
		final String text = "StayHome.ch est une initiative privée d'une personne désireuse d'apporter son aide pour faire face aux conséquences de l'épidémie de COVID-19. Elle n'a aucun objectif mercantile.";
	...
	void testDetectItalian() {
		// given
		final String text = "StayHome.ch é un iniziativa privata di una persona desiderosa di aiutare di fronte alle conseguenze dell'epidemia di COVID-19. Iniziativa senza scopo di lucro.";
	...
	void testDetectEnglish() {
		// given
		final String text = "StayHome.ch is an initiative of a private person willing to help to cope with the consequences of the COVID-19 epidemy. It has no commercial purpose.";
	...
	void testDetectUnsupportedLanguage() {
		// given
		final String text = "StayHome.ch es una iniciativa privada de una persona que desea ayudar a hacer frente a las consecuencias de la epidemia de COVID-19. No tiene objetivo mercantil.";
